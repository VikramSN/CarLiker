<%-- 
    Document   : fbook
    Created on : Aug 3, 2017, 7:16:18 PM
            ...
            <center><div class="priceing-table w3l">
				...
				document.getElementById("bid").innerHTML = x;
		    		    ...
		    		    <div class="price-selet pric-sclr2">
                                        <a class="btn" href="#small-dialog">Thank you for Booking Car at<strong> www.CarLiker.com</strong></a><br><br>
                                                                     <a class="btn" href="buy_product.jsp"><strong>Click here buy product</strong></a>
		    			</div>
						</div>
                        </div>
						</div></center>
